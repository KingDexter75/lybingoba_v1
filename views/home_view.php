          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  <span>PLEG-H-E en Geographie.
                    •	Chargé de la salle Informatique
                    •	Inscription aux examens OBC (probatoire)
                    •	Chargé du bilinguisme, multiculturalisme et du vivre ensemble.
                    •	Chargé du suivi des résolutions des réunions de coordination administratives
                    •	Chargé des évaluations internes sous système francophone 
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  <span>conseillère d'orientation .
                    •	Chargé des inscriptions aux  examens DECC
                    •	Chargé de la carrière du personnel  
                    •	Rédaction des rapports des réunions de coordination administrative 
                    •	Evaluation : sous-système francophone
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  <span>PLEG-H-E en	SVT	 en charge des :
                    •	Inscription aux examens OBC (baccalauréat)
                    •	Chargé des infrastructures
                    •	Chargé des emplois de temps sous-système francophone 
                  </span>
                  <i class="bi bi-quote quote-icon-right"></i>
                </p>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  <span>PLEG-H-E en Physique . 
                    •	Chargé du suivi du matériel didactique 
                    •	Chargé du suivi des requêtes des bulletins
                    •	Chargé du service de la scolarité
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/testimonials/testimonials-5.jpg" class="testimonial-img" alt="">
                <h3>CHRISTOPHER WAZIE ASONGWE </h3>
                <h4>Censeur</h4>
                <div class="stars">
                  <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
                </div>
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  <span>PLEG-H-E en PHYSICS	ALL THE SCIENCE SUBJECTS	FI, F5, L6 Upper 6 
                    •	Collecte et analyse des statistiques de la section anglophone. 
                    •	Chargé de la digitalisation des enseignements
                    •	Chargée du Laboratoire.
                    •	Suivi et évaluation des activités de la section anglophone
                    •	Chargé des évaluations dans le sous système anglophone 
                    •	Chargé des ressources humaines section Anglophone 
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  <span>PLEG-H-E en histoire. en charge du :
                    Censeur en charge du departement de francais.
                    Reponsable des niveaux 5eme, 4eme.
                  </span>
                  <i class="bi bi-quote quote-icon-right"></i>
                </p>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>
                  <i class="bi bi-quote quote-icon-left"></i>
                  <span>PLEG-H-E en histoire-geographie-ecm.
                    Censeur en charge du departement de francais.
                    Reponsable des niveaux 5eme, 4eme.
                  </span>
                  <i class="bi bi-quote quote-icon-right"></i>
